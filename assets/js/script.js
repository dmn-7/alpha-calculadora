...
document.getElementById('calculate').addEventListener('click', function(){
    ...
    const total2 = (value1-((Math.floor(total))* value2));

    document.getElementById('total').innerHTML=(Math.floor(total) + " - PALLET COMPLETOS ( Obs: Cada pallet completo tem " + value2 + " caixas )")
    document.getElementById('total2').innerHTML=(Math.floor(total2) + " - CAIXA ")
});
